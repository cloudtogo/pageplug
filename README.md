<p align="center">
  <img src="static/pageplug/new-banner.svg" width="361" height="160" alt="PagePlug">
</p>
...
> 当前源码版本为v1.9.38，社区版ce镜像版本为v1.9.38版本，企业版ee镜像版本为v1.9.40，企业版v1.10推送更新后会推送社区版v1.9.39更新，敬请期待。
...
- 引入 antd 组件库，支持Antd5，react 版本升级到 v18

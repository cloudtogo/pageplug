...
@Getter
public enum RedshiftPluginError implements BasePluginError {
    ...
    RedshiftPluginError(Integer httpErrorCode, String appErrorCode, String message, AppsmithErrorAction errorAction,

...
@Getter
public enum RestApiPluginError implements BasePluginError {
    ...
    RestApiPluginError(Integer httpErrorCode, String appErrorCode, String message, AppsmithErrorAction errorAction,

...
@Getter
public enum RedisPluginError implements BasePluginError {
    ...
    RedisPluginError(Integer httpErrorCode, String appErrorCode, String message, AppsmithErrorAction errorAction,

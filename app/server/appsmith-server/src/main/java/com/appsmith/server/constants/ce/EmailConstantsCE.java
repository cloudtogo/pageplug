...
public class EmailConstantsCE {
    ...
    public static final String PRIMARY_LINK_TEXT_INVITE_TO_INSTANCE_CE = "Join your Pageplug instance";
    public static final String PRIMARY_LINK_TEXT_WORKSPACE_REDIRECTION = "Go to your Pageplug workspace";

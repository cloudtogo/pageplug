...
public enum AppsmithError {
    ...
    CLOUDOS_REQUEST_SYNC_API_FAILURE(500, AppsmithErrorCode.CLOUDOS_API_ERROR.getCode(), "API获取失败: {0}", AppsmithErrorAction.LOG_EXTERNALLY, null, ErrorType.BAD_REQUEST, null),
    CLOUDOS_WECHAT_ACCESS_TOKEN_FAILURE(500, AppsmithErrorCode.CLOUDOS_WECHAT_TOKEN_ERROR.getCode(), "微信 access_token 获取失败: {0}", AppsmithErrorAction.LOG_EXTERNALLY, null, ErrorType.BAD_REQUEST, null),
    CLOUDOS_WECHAT_PREVIEW_FAILURE(500, AppsmithErrorCode.CLOUDOS_WECHAT_PREVIEW_ERROR.getCode(), "微信小程序码获取失败: {0}", AppsmithErrorAction.LOG_EXTERNALLY, null, ErrorType.BAD_REQUEST, null),

...
export function ApplicationsSection(props: any) {
  ...
  if (
    ...
    const onClickAddNewAppButton = (workspaceId: string, isTaroWds?:boolean) => {
      if (
            ...
            {!isLoadingResources && (
              <WorkspaceShareUsers>
                ...
                <WorkspaceAction
                  ...
                  isMobile={isMobile}
                  onCreateNewApplication={(workspaceId:any, isTaroWds?: boolean) => onClickAddNewAppButton(workspaceId, isTaroWds)}

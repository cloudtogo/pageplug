...
import { FormDataProps } from "sagas/ActionExecution/PluginActionSagaUtils";
...
class ActionAPI extends API {
  ...
  static executeAction(
    executeAction: FormDataProps,
    timeout?: number,
  ): AxiosPromise<ActionExecutionResponse> {
    const actionForm = executeAction.getData();
    return API.post(ActionAPI.url + "/execute", actionForm.buffer, undefined, {
      timeout: timeout || DEFAULT_EXECUTE_ACTION_TIMEOUT_MS,
      headers: {
        accept: "application/json",
        "Content-Type": actionForm.contentType,
      },
    });
  }

...
export enum WidgetTypes {
  ...
  TARO_SKU_WIDGET = "TARO_SKU_WIDGET",
  TARO_KV_WIDGET = "TARO_KV_WIDGET",
  TARO_TABS_WIDGET = "TARO_TABS_WIDGET",
  TARO_BOTTOM_BAR_WIDGET = "TARO_BOTTOM_BAR_WIDGET",
  TARO_ACTION_BAR_WIDGET = "TARO_ACTION_BAR_WIDGET",
  TARO_SEARCH_WIDGET = "TARO_SEARCH_WIDGET",
  TARO_LOADING_WIDGET = "TARO_LOADING_WIDGET",
  TARO_CHECKBOX_WIDGET = "TARO_CHECKBOX_WIDGET",
  TARO_FORM_WIDGET = "TARO_FORM_WIDGET",
}
...
export const layoutConfigurations: LayoutConfigurations = {
  ...
  MOBILE_FLUID: { minWidth: -1, maxWidth: -1 },
};
